...
# Set of 15 OGs that are widely conserved (present in most species), rarely occur as duplicate genes in known genomes, are not subject 
# to horizontal gene transfer, and do not scale with genome size as marker genes (Raes et al., 2007).
